...
const MenuNotLogado = () => (
  <div className="flex space-x-4">
    <nav className="flex space-x-2 content-center items-center place-content-center">
      ...
      <div className='flex space-x-0.5 pr-1 content-center items-center place-content-center'>
        <Link href="/login">
    ...
    <Menu as="div" className="relative sm:hidden">
      {({ open }) => (
        <>
          <div>
            <Menu.Button className="flex -ml-3 text-sm focus:outline-none active:opacity-50 hover:opacity-50 duration-300">
          ...
          >
            ...
            >
              ...
              <Menu.Item>
                <div className="flex mt-2 justify-center text-xl font-bold duration-300">
                  <Link href='/community'>
                    <a className="bg-[length:400px_400px] bg-gradient-to-r from-blue-600 via-purple-600 
                      to-blue-600 bg-clip-text text-transparent px-1 py-1 animate-[mygradient_3s_ease_infinite] 
              ...
              <Menu.Item>
                <div className="flex justify-center space-x-2 pt-3 text-normal font-medium duration-300 mb-3">
                  <Link href="/login">
                    <a
